...
function sendmsg($pdo, $sender_id, $receiver_id){
                        $content = "<p>尊敬的用户，</p>
<p>感谢您使用我们的小程序，并提交了碳减排相关证据。我们很遗憾地通知您，由于您提交的碳减排证据存在一些错误，我们不得不对您的碳积分进行了更改。</p>
<p>我们建议您仔细检查您的证据，并确保准确地记录您的碳减排行为。如果您有任何疑问或需要进一步的帮助，请随时联系我们的团队。我们将竭诚为您提供支持和帮助。</p>
<p>我们感谢您对环境保护事业的关注和努力，并对您的理解和支持表示衷心的感谢。</p>
